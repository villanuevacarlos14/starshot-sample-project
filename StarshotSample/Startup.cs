...
using Starshot.Service.Mapping;
using Starshot.Web.Models;

namespace StarshotSample
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<StarshotDbContext>(options => options.UseSqlServer(this.Configuration.GetConnectionString("Starshot"), b => b.MigrationsAssembly("Starshot.Web")));
            services.AddSingleton<IMapper>(o => new Mapper(
